...
const Cei = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={ceiImg} rightMessage={
                <div>
...
const Aii = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={Assii} rightMessage={
                <p>
...
const Rf = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={rechFinancement} rightMessage={
                <p>
...
const Mr = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={relation} rightMessage={
                <p>
...
const Se = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={strategy} rightMessage={
                <p>
            ...
            } titreService="STRATEGIE ENTREPRISE" />
        </div>
    );
};
...
const Gsp = () => {
    return (
        <div className="service-details-content">
            <ServicesDetails imageLeft={manage} rightMessage={
                <div>
                    <p>
